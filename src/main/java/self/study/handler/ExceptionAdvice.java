...
public class ExceptionAdvice {
    ...
    private class LoginFailureException extends Throwable {
    }

    private class MemberEmailAlreadyExistsException extends Throwable {
    }

    private class MemberNicknameAlreadyExistsException extends Throwable {
    }

    private class MemberNotFoundException extends Throwable {
    }
}
